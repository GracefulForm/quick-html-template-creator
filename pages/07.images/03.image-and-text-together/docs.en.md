...
taxonomy:
    category:
        - docs
media_order: 'image-text-columns.jpg,listings.jpg'
---
...
![Use HTML to make a blog or product listing.](listings.jpg "Blog or Product Listings")
...
<div class="w3-content">
	...
	<div class="w3-row w3-margin">
		...
		<div class="w3-twothird w3-container">
			...
			<a href="#" class="w3-black w3-button w3-small w3-round w3-right">Add to Cart</a>
		</div>
	</div>
	<hr>	
</div>
